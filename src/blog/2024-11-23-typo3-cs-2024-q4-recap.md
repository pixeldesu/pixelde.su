...
The logic to get the parent in the select-tree implementation was flawed; onlyI
worked for category trees with a single level and fixed this in this patch.
...
part was a bit more tricky because it also required more consideration of the
RTE and CKEditor.
...
<figure class="m-0">
<img class="rounded-md" src="/assets/img/blog/cs-q4-recap/ckeditor.png" alt="Screenshot of the CKEditor UI in the TYPO3 backend in dark mode"/><figcaption class="italic text-center font-normal">The CKEditor UI, in dark mode</figcaption>
</figure>
...
This is a small request: adjust the new Site Settings module to show values of
enum fields as it does in other Form Engine fields.
...
<figure class="m-0">
<img class="rounded-md" src="/assets/img/blog/cs-q4-recap/site-settings.png" alt="Screenshot of the TYPO3 site settings, a labelled dropdown visible"/>
<figcaption class="italic text-center font-normal">A select field in site settings, showing the actual value</figcaption>
</figure>
...
interfaces, you could onlysee the orange emblem part of the logo because the
text would be white on a white background.

I initially opted to fix this by enforcing e-mails to always be styled in light
mode only, but I was then told to add dark mode to the system e-mails.
...
<figure class="m-0">
<img class="rounded-md" src="/assets/img/blog/cs-q4-recap/email.png" alt="Screenshot of a TYPO3 password reset email in a dark theme"/>
<figcaption class="italic text-center font-normal">The TYPO3 "Forgot password" email in dark mode</figcaption>
</figure>
...
<div class="outline-dashed outline-2 bg-lime-50 outline-lime-600 dark:bg-lime-400/25 px-2 py-1 rounded-md leading-snug italic text-center mb-3">
  Thanks to my employer <a href="https://in2code.de" target="_blank">in2code GmbH</a> for counting sprint participation as work time for me, it's much appreciated!
</div>
